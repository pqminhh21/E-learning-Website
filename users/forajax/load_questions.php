...
$res=mysqli_query($conn,"SELECT * FROM add_ques WHERE category='$_SESSION[exam_category]' && ques_no=$_GET[questionno]");
...
if($count==0){
    ...
    <table class="table border-0 ms-5">
        ...
        <tr>
            <td class="border-0">
                <input type="radio" value="<?php echo $opt3; ?>" name="r1" id="r1" onclick="radioclick(this.value,<?php echo $question_no ?>)"
                <?php
                if($ans==$opt3){
                    echo "checked";
                }
