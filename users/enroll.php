...
if (isset($_REQUEST['payment'])) {
    ...
    $length = 16; // Độ dài của chuỗi hex
    $order_id = bin2hex(random_bytes($length)) . mt_rand(1000, 9999);
    ...
    if ($conn->query($sql) == TRUE) {
        ...
        echo "<script>setTimeout(()=>{window.location.href='course.php';},1500);</script>";
    } else {
        ...
        <form action="" method="POST">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="inputBox">
                        <span>Amount :</span>
                        <input type="text" name="price" readonly value="Price <?php echo $row['course_price'] ?>">
                    </div>
                    <div class="inputBox">
