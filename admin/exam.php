                            ...
                            <table class="table ">
                                ...
                                <tbody>
                                    <?php while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo '<td>';
                                        echo '
                <form action="edit-exam.php" method="POST" class="d-inline">
                ...
                <input type="hidden" name="id" value=' . $row["id"] . '>
                    <button type="submit" class="btn btn-secondary" name="delete" value="Delete">
                        ...
                        if (isset($_REQUEST['delete'])) {
                            ...
                            // Xóa dữ liệu từ bảng add_ques dựa trên exam_name
                            $deleteQuesSql = "DELETE FROM add_ques WHERE category IN (SELECT exam_name FROM exam_category WHERE id = $examId)";
                            if ($conn->query($deleteQuesSql) === TRUE) {
                                // Xóa category từ bảng exam_category
                                $deleteCategorySql = "DELETE FROM exam_category WHERE id = $examId";
